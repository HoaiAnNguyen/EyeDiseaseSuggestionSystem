...
<body>
            ...
            <nav class="w3-col m3 w3-row-padding w3-round-large w3-animate-left" style="z-index:3" id="mySidebar">
                <div class="w3-row m3 w3-row-padding w3-margin-top w3-round-large" style="background-color: #ffd1dc">
                    <div class="w3-container w3-margin-top w3-margin-bottom">
                        ...
                        <h1 class="food-and-drink-title">USAGE INSTRUCTION</h1>
                        <br>
                        <p style="text-align: center">This function aids ophthalmologists in giving medicine prescriptions.</p>
                        <p style="text-align: center">Usage guidance of ophthalmic medicine is recommended by the system to help decrease the amount of time ophthalmic practitioners spend on writing prescriptions.</p>
                    </div>
                </div>
                ...
                <div class="w3-row m3 w3-row-padding w3-margin-bottom w3-margin-top w3-round-large w3-collapse" style="z-index:3; background-color: #ffd1dc">
                    <div class="w3-container w3-margin-top w3-margin-bottom">
                        <a class="main w3-bar-item w3-button w3-padding">
                            <i class='w3-margin-right fas fa-sign-in-alt'></i>Input: Medicine
                        </a>

                        <a class="main w3-bar-item w3-button w3-padding">
                            <i class="fas fa-sign-out-alt w3-margin-right"></i>Output: Instructions
                        </a>
            ...
            <div class="w3-col m9 w3-container w3-row-padding w3-margin-top w3-round-large w3-animate-right" style="background-color: #ffd1dc">
                ...
                <div class="w3-col m4 w3-row-padding w3-round-large w3-animate-right" style="z-index:3" id="mySidebar">
                    <div class="SymptomsGroup">
                        <div class="btn-group">
                            <div class="buttonSymptom" id="buttonSymptom1">Efticol 0,9%</div>
                            <div class="buttonSymptom" id="buttonSymptom2">Hylene/Na Hyaluronate</div>
                            <div class="buttonSymptom" id="buttonSymptom3">Logpatat/Vitamin A, E</div>
                            <div class="buttonSymptom" id="buttonSymptom4">Dewoton/Vitamin, Minerals</div>
                            <div class="buttonSymptom" id="buttonSymptom5">Eporon/Fluorometholone 1mg/ml</div>
                            <div class="buttonSymptom" id="buttonSymptom6">Govarom/Tobramycin, Dexamethasone</div>
                            <div class="buttonSymptom" id="buttonSymptom7">Orzynase</div>
                            <div class="buttonSymptom" id="buttonSymptom8">Vismed 0,3ml/Na Hyaluronate 0.18%</div>
                            <div class="buttonSymptom" id="buttonSymptom9">Sanlein 0,1%/Na Hyaluronate</div>
                        </div>
                    </div>
                    <p id="demo"></p>
    ...
    <script>
        ...
        buttonSymptomElement3.onclick = () => {
            Symptom_Name.push("Logpatat (Vitamin A, E)");
            symps.textContent = `${Symptom_Name}`;
            var Title = "Instruction:";
            DiseaseTitle.textContent = `${Title}`;
            var medicine="hehe";
        ...
        buttonSymptomElement4.onclick = () => {
            Symptom_Name.push("Dewoton (Vitamin, Minerals)");
            symps.textContent = `${Symptom_Name}`;
            var Title = "Instruction:";
            DiseaseTitle.textContent = `${Title}`;
            var medicine="hehe";
        ...
        buttonSymptomElement5.onclick = () => {
            Symptom_Name.push("Eporon (Fluorometholone 1mg/ml)");
            symps.textContent = `${Symptom_Name}`;
            var Title = "Instruction:";
            DiseaseTitle.textContent = `${Title}`;
        ...
        buttonSymptomElement6.onclick = () => {
            Symptom_Name.push("Govarom (Tobramycin, Dexamethasone)");
            symps.textContent = `${Symptom_Name}`;
            var Title = "Instruction:";
            DiseaseTitle.textContent = `${Title}`;
        ...
        buttonSymptomElement7.onclick = () => {
            Symptom_Name.push("Orzynase");
            symps.textContent = `${Symptom_Name}`;
            var Title = "Instruction:";
            DiseaseTitle.textContent = `${Title}`;
            var medicine="Uống. Người lớn: Liều khởi đầu 2 viên/lần, ngày 2-4 lần. Sau duy trì 1 viên/ lần, ngày 2-4 lần.";
            Disease1.textContent=`${medicine}`;
        }
        buttonSymptomElement8.onclick = () => {
            Symptom_Name.push("Vismed 0,3ml (Na Hyaluronate 0.18%)");
            symps.textContent = `${Symptom_Name}`;
            var Title = "Instruction:";
            DiseaseTitle.textContent = `${Title}`;
            var medicine="hehe";
        ...
        buttonSymptomElement9.onclick = () => {
            Symptom_Name.push("Sanlein 0,1% (Na Hyaluronate)");
            symps.textContent = `${Symptom_Name}`;
            var Title = "Instruction:";
            DiseaseTitle.textContent = `${Title}`;
            var medicine="hehe";
