...
<body>
            ...
            <div class="w3-col m9 w3-container w3-row-padding w3-margin-top w3-round-large w3-animate-right" style="background-color: #ffd1dc">
                ...
                <div class="w3-col m4 w3-row-padding w3-round-large w3-animate-right" style="z-index:3" id="mySidebar">
                    <div class="SymptomsGroup">
                        <div class="btn-group">
                            <div class="buttonSymptom" id="buttonSymptom1">Đau mắt</div>
                            <div class="buttonSymptom" id="buttonSymptom2">Đỏ mắt</div>
                            <div class="buttonSymptom" id="buttonSymptom3">Mờ mắt</div>
                            <div class="buttonSymptom" id="buttonSymptom4">Mỏi điều tiết</div>
                            <div class="buttonSymptom" id="buttonSymptom5">Rối loạn nước mắt</div>
                            <div class="buttonSymptom" id="buttonSymptom6">Lẹo</div>
                            <div class="buttonSymptom" id="buttonSymptom7">Dị vật</div>
                            <div class="buttonSymptom" id="buttonSymptom8">Xuất huyết</div>
                            <div class="buttonSymptom" id="buttonSymptom9">Phù nề</div>
                            <div class="buttonSymptom" id="buttonSymptom10">Rung giật nhãn cầu</div>
    ...
    <script>
        ...
        SubmitSymptomFunction.onclick = () => {
            ...
            const disease=["Trầy giác mạc,Rách võng mạc","Rách võng mạc,Đục thủy tinh thể","Viêm giác mạc,Đục thủy tinh thể,Cận thị","Cận thị,Đục thủy tinh thể","Đục thủy tinh thể,Cận thị,Rối loạn phim nước mắt","Viêm giác mạc,Cận thị,Loạn thị"];
